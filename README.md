...
**Flickgram** is a photo sharing app using Parse as its backend.
...
1. How can we speed up data retrieval from the database?
2. I could add a likes and comments component to each post.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<a href="https://imgflip.com/gif/2lfde0"><img src="https://i.imgflip.com/2lfde0.gif" title="made at imgflip.com"/></a>
...
Acquiring data from the database was a bit diffcult.
